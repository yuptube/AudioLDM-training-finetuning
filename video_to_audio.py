...
duration = 5
waveform=None
checkpoint = "audioldm-m-full.ckpt"
...
video_file = "quack.mp4"
audio_path = "imagebind/.assets/bird_audio.wav"
text = "" # must be string

# ==== Load Latent Diffusion Model from Checkpoint ====
seed_everything(42)

audioldm = build_model(checkpoint ,audio_ldm_yaml, "audioldm-m")
...
batch = make_batch_form_text_to_audio(text,waveform=waveform , fname="trumpt")
