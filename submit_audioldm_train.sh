...
python3 audioldm_train/train/latent_diffusion.py -c audioldm_train/config/audioldm_original_with_imagebind/audioldm_with_imagebind.yaml \
        --reload_from_ckpt log/latent_diffusion/audioldm_original_with_imagebind/audioldm_with_imagebind/checkpoints/checkpoint-fad-133.00-global_step=4999.ckpt
